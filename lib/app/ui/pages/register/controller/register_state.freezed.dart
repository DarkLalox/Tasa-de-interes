...
mixin _$RegisterState {
  ...
  String get namepyme => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      name: name == freezed
          ...
          : name // ignore: cast_nullable_to_non_nullable
              as String,
      namepyme: namepyme == freezed
          ? _value.namepyme
          : namepyme // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$_RegisterState implements _RegisterState {
  ...
  @override
  String toString() {
    return 'RegisterState(email: $email, password: $password, vPassword: $vPassword, name: $name, namepyme: $namepyme, termsOk: $termsOk)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _RegisterState &&
            ...
            (identical(other.namepyme, namepyme) ||
                const DeepCollectionEquality()
                    .equals(other.namepyme, namepyme)) &&
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(namepyme) ^
